...
import type { Footer, Brand } from '@/payload-types'
  ...
  return (
    <footer className="border-t border-border bg-black dark:bg-card text-white">
      <div className="container py-8 gap-8 flex flex-col md:flex-row md:justify-between">
        ...
        {/* <div className="mt-16 border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24"> */}
        <ul className="mt-8 flex md:justify-center items-center gap-6 sm:mt-0 lg:justify-end">
          {linkedin && (
            <li>
              <a
                href={linkedin}
